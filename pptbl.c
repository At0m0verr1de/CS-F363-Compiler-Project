...
NODE ***initPredictiveParsingTable()
{
    ...
    // add nulls at the end of the following arrays if code fails
    char *Terminals[] = {
...
int main()
{
    ...
    char *terminal = "TK_DEFINETYPE";
    char *nonTerminal = "actualOrRedefined";
    printf("%s\n", predictiveParsingTable[hashNT(nonTerminal)][hashT(terminal)]->name);
    return 0;
}
